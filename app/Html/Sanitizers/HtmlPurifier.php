...
class HtmlPurifier implements Sanitizer
{
    ...
    public function __construct()
    {
        ...
        $config->set('HTML.AllowedElements', ['table','th','tr','tbody','thead','td','b', 'i', 'p', 'a', 'strong', 'em', 'img', 'font', 'br', 'span', 'div', 'blockquote', 'ol', 'ul', 'li', 'pre', 'font','hr','strike','s','sup','sub']);
        $config->set('HTML.AllowedAttributes', ['a.href', 'a.target', '*.id', '*.class', 'p.style', 'div.style', 'span.style', 'pre.style', 'img.src', 'img.alt', 'img.title', '*.width', '*.height', 'img.style', 'font.size', 'font.color', 'font.face','table.border','table.style', 'td.style', 'th.style', 'tr.style']);
